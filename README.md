...
DIY guides for a Tampa, Florida backyard.
...
- `Tampa_Fence_Heat_Solutions.pdf` — what to do about white vinyl fence heat bounce
...
python3 create_fence_heat_guide.py
